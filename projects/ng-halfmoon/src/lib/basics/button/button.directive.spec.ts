...
function getElementByDirective(
  fixture: ComponentFixture<ButtonTestComponent>
): DebugElement {
...
describe('ButtonDirective', () => {
  ...
  it('should create an instance', () => {
    expect(
      fixture.debugElement.query(By.directive(ButtonDirective))
    ).toBeDefined();
  });
  ...
  describe('appearance', () => {
    it('should apply no appearance-class', () => {
      fixture.detectChanges();
      expect(
        getElementByDirective(fixture).nativeElement.classList.contains(
          'btn-primary'
        )
      ).toEqual(false);
      expect(
  ...
  describe('disabled', () => {
    it('should not apply disabled', () => {
      ...
      expect(
        getElementByDirective(fixture).nativeElement.hasAttribute('disabled')
      ).toEqual(false);
    });
    it('should apply "btn-rounded"', () => {
